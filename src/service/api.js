...
const send = async ({ method = '', path = '', data = {} } = {}) => {
    const commonURl =
        'http://parkick2-env.eba-aype8prr.ap-northeast-2.elasticbeanstalk.com:80'; // 백엔드 서버 주소
    const url = commonURl + path; // API로 전달될 주소

    const headers = {
        'Access-Control-Allow-Origin':
            'http://parkick2-env.eba-aype8prr.ap-northeast-2.elasticbeanstalk.com:80', // 백엔드 서버의 주소. 크로스 도메인 대응
